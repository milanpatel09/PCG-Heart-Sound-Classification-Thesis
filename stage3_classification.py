...
def main():
    ...
    # This ensures:
    # 1. No leakage (Groups kept intact)
    ...
    for t_idx, v_idx in sgkf.split(full_dataset.X, full_dataset.y, groups=groups):
    ...
    if len(train_groups.intersection(val_groups)) == 0:
        ...
        raise ValueError("❌ LEAKAGE DETECTED: Patients overlap between Train and Val!")
